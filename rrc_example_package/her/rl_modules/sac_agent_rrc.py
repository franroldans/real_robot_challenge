...
class sac_agent_rrc:
    def __init__(self, env, args, env_params):
        ...
        self.qf1 = flatten_mlp(env_params['obs'], 3, env_params['action'])
        self.qf2 = flatten_mlp(env_params['obs'], 3, env_params['action'])
        # set the target q functions
        self.target_qf1 = copy.deepcopy(self.qf1)
        self.target_qf2 = copy.deepcopy(self.qf2)
        # build up the policy network
        self.actor_net = tanh_gaussian_actor(env_params['obs'], env_params['action'], 3, \
